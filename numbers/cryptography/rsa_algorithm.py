...
from numbers.arithmetic_functions import phi
from numbers.cryptography import EncryptionDevice
from numbers.random_prime_generator import RandomPrimeGenerator
