...
from fermath.quadratic_reciprocity import get_quadratic_non_residue
from fermath.primality_testing import is_prime
from fermath.diophantine_expressions.diophantine_expression import DiophantineSolution, \
